...
import { CreateSmsTemplateDto, UpdateSmsTemplateDto } from '../../../../utils/dto/sms-template.dto';
...
export class SmsTemplateDashboardController {
	...
	/**
	 * Admin uchun yangi SMS shablon yaratish
	 */
	@Post('/create')
	@HttpCode(201)
	...
	@Auth()
	async create(
		@Body() body: CreateSmsTemplateDto & { user_id: number },
	): Promise<SingleResponse<SmsTemplateEntity>> {
		return await this.smsTemplateService.create(body, body.user_id);
	}
